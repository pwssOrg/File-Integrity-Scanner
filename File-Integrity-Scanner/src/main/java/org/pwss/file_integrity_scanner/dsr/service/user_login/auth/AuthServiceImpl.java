 ...
 * the repository is empty. It extends {@code PWSSbaseService} which contains
 * common functionality shared among service implementations.
 */
@Service
public class AuthServiceImpl extends PWSSbaseService<AuthRepository, Auth, Integer> implements AuthService {
