package org.pwss.file_integrity_scanner.dsr.service.scan;
...
import org.pwss.file_integrity_scanner.dsr.domain.entities.monitored_directory.MonitoredDirectory;
...
import org.pwss.file_integrity_scanner.dsr.domain.model.scan.ScanTaskState;
import org.pwss.file_integrity_scanner.dsr.domain.model.scan.enumeration.ScanStatus;
import org.pwss.file_integrity_scanner.dsr.repository.ScanRepository;
...
public class ScanServiceImpl extends BaseService<ScanRepository> implements ScanService {
    ...
    private void processFile(File file, Scan scanInstance) {
        ...
        org.pwss.file_integrity_scanner.dsr.domain.entities.file.File fileEntity;
        if (fileInDatabase) {
            ...
            // Create new entity
            fileEntity = new org.pwss.file_integrity_scanner.dsr.domain.entities.file.File();
